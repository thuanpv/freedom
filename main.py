...
def init():
    ...
    print("main.py initialize html attributes")
    initialize_html_attributes()
    print("main.py initialize html functions")
    initialize_html_functions()
    print("main.py initialize html html properties")
    initialize_html_properties()
    print("main.py initialize svg attributes")
    initialize_svg_attributes()
    print("main.py initialize svg functions")
    initialize_svg_functions()
    print("main.py initialize svg properties")
    initialize_svg_properties()
    print("main.py initialize misc apis")
